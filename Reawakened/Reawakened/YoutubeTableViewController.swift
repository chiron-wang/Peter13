...
class YoutubeTableViewController: UITableViewController {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        guard let contentID = segue.identifier, let youtubeViewController = segue.destination as? YoutubeViewController else { return }
        youtubeViewController.contentID = contentID
    }
