//
//  RunningManTableViewController.swift
//  SkechersBuy
//
//  Created by mikewang on 2019/9/21.
//  Copyright © 2019 mikewang. All rights reserved.
//

import UIKit

class RunningManTableViewController: UITableViewController {
    
    @IBOutlet var manLabels: [UILabel]!
    @IBOutlet var manSteppers: [UIStepper]!    
    ...
    @IBAction func manStepperValueChanged(_ sender: UIStepper) {
        ...
        manLabels[index].text = count.description
